    ...
    <div>
        <ol className="relative border-l border-green-800">                  
            <li className="mb-10 ml-4">
                ...
                <time className="mb-1 text-sm font-normal leading-none text-emerald-800 bg-red-200 rounded-lg p-1">February 2022</time>
                <h3 className="text-lg font-semibold text-emerald-900 ">Application UI code in Tailwind CSS</h3>
            ...
            <li className="mb-10 ml-4">
                <div className="absolute w-3 h-3 bg-emerald-200 rounded-full mt-1.5 -left-1.5 border border-green-500"></div>
                <time className="mb-1 text-sm font-normal leading-none text-emerald-800 bg-red-200 rounded-lg p-1">April 2022</time>
                <h3 className="text-lg font-semibold text-emerald-900 ">E-Commerce UI code in Tailwind CSS</h3>
